...
ALTER TABLE imovel ADD CONSTRAINT FK_imovel_proprietario FOREIGN KEY (fk_proprietario_codigo) REFERENCES proprietario (codigo) ON DELETE RESTRICT;
ALTER TABLE imovel ADD CONSTRAINT FK_imovel_financeiro FOREIGN KEY (fk_financeiro_codigo) REFERENCES financeiro (codigo) ON DELETE RESTRICT;
ALTER TABLE imovel ADD CONSTRAINT FK_imovel_endereco FOREIGN KEY (fk_endereco_codigo) REFERENCES imovel_endereco (codigo);

ALTER TABLE atendimento ADD CONSTRAINT FK_atendimento_usuario FOREIGN KEY (fk_usuario_codigo) REFERENCES usuario (codigo) ON DELETE RESTRICT;

ALTER TABLE usuario ADD CONSTRAINT FK_usuario_endereco FOREIGN KEY (fk_usuario_endereco_codigo) REFERENCES usuario_endereco (codigo);

ALTER TABLE agendamento ADD CONSTRAINT FK_agendamento_atendimento FOREIGN KEY (fk_atendimento_codigo) REFERENCES atendimento (codigo) ON DELETE RESTRICT;
ALTER TABLE agendamento ADD CONSTRAINT FK_agendamento_visita FOREIGN KEY (fk_visita_codigo) REFERENCES visita (codigo);

ALTER TABLE visita ADD CONSTRAINT FK_visita_anotacao FOREIGN KEY (fk_anotacao_codigo) REFERENCES anotacao (codigo);

ALTER TABLE financeiro ADD CONSTRAINT FK_financeiro_atendimento FOREIGN KEY (fk_atendimento_codigo) REFERENCES atendimento (codigo) ON DELETE RESTRICT;
ALTER TABLE financeiro ADD CONSTRAINT FK_financeiro_cliente FOREIGN KEY (fk_cliente_codigo) REFERENCES cliente (codigo) ON DELETE RESTRICT;

ALTER TABLE cliente_endereco ADD CONSTRAINT FK_cliente_endereco FOREIGN KEY (fk_cliente_codigo) REFERENCES cliente (codigo) ON DELETE RESTRICT;
